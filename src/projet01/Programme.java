...
//		op.atelier10();
	...
	public void atelier10() {
		...
		String tab[][] = { { "Pikachu", "Raichu" }, { "Salamèche" }, { "Bulbizarre" }, { "Carapuce", "Torkank" },
				{ "Onyx", "Racaillou" } };
		int e;
		int j;
	...
	public void atelier11() {
		...
		System.out.println("Il vous reste 5 chances");
		System.out.println("****************************");
		...
		if (b == i) {
			...
			System.out.println("Bravo "+z+"!!Vous avez réussi");
		} else {
			System.out.println("Il vous reste 4 chances");
			System.out.println("****************************");
			System.out.println("Veuillez entrer un nombre : ");
		}
		int a = sc.nextInt();
		if (a == i) {
			...
			System.out.println("Il vous reste 3 chances");
			System.out.println("****************************");
			System.out.println("Veuillez entrer un nombre : ");
		}
		int c = sc.nextInt();
		if (c == i) {
			...
			System.out.println("Il vous reste 2 chances");
			System.out.println("****************************");
			System.out.println("Veuillez entrer un nombre : ");
		}
		int d = sc.nextInt();
		if (d == i) {
			...
			System.out.println("Il vous reste 1 chances");
			System.out.println("****************************");
			System.out.println("Veuillez entrer un nombre : ");
		}
		int e = sc.nextInt();
		if (e == i) {
			...
			System.out.println("Dommage! "+z+" Tu as perdu!!");
